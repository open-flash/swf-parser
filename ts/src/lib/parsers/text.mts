...
import { FontAlignmentZoneData} from "swf-types/text/font-alignment-zone-data";
import { FontAlignmentZone} from "swf-types/text/font-alignment-zone";
import { FontLayout } from "swf-types/text/font-layout";
import { GlyphEntry } from "swf-types/text/glyph-entry";
import { GridFitting } from "swf-types/text/grid-fitting";
import { KerningRecord } from "swf-types/text/kerning-record";
