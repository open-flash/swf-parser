...
import { FillStyle } from "swf-types/fill-style";
...
import { LineStyle } from "swf-types/line-style";
import { Matrix } from "swf-types/matrix";
import { ShapeRecord } from "swf-types/shape-record";
import { ShapeRecordType } from "swf-types/shape-records/_type";
import * as shapeRecords from "swf-types/shape-records/index";
...
export function capStyleFromId(capStyleId: Uint2): CapStyle {
  switch (capStyleId) {
    ...
    default:
      throw new incident.Incident("UnexpectedCapStyleId", {id: capStyleId});
  }
}
